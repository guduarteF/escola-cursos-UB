...
SECRET_KEY = 'django-insecure-ll8qj0)f!6b84t_@_3c@ct!(4sdr(((cbjq#m%v9#thk-_@f2^'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 2,
    # Throttling (limita a quantidade de request por usuario)
...
# Token ee11c53d836f28c5bd7e4cafbf49c552847aa901